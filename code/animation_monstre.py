...
class AnimateSpriteMonstre (pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.anim_monstre = {}
        self.ajoute_monstre("slime", int(90*S))
    ...
    def ajoute_monstre(self, name, y):
        ...
        for i in range (4):
            self.anim_monstre[name]["mouvement"].append(self.get_image(int((1150+i*580)*S),y))
            self.anim_monstre[name]["mouvement"][i].set_colorkey([196,196,187])
        for i in range (4):
            self.anim_monstre[name]["mouvement"].append(self.get_image(int((1150+i*580)*S),y+int(290*S)))
            self.anim_monstre[name]["mouvement"][i+4].set_colorkey([196,196,187])
        for i in range (4):
            self.anim_monstre[name]["mouvement"].append(self.get_image(int((1150+i*580)*S),y+int(570*S)))
            self.anim_monstre[name]["mouvement"][i+8].set_colorkey([196,196,187])
        for i in range (3):
            self.anim_monstre[name]["mouvement"].append(self.get_image(int((1150+i*580)*S),y+int(870*S)))
            self.anim_monstre[name]["mouvement"][i+12].set_colorkey([196,196,187])

        self.anim_monstre[name]["attaque"].append(self.get_image(int((1150+3*580)*S),y+int(870*S)))
